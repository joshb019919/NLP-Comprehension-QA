...
from src.common import atomic_save_json, configure_runtime, maybe_set_process_memory_limit
...
def safe_load_tokenizer_and_model(config: AppConfig):
...
def main() -> None:
    ...
    try:
        tokenizer, model = safe_load_tokenizer_and_model(config)
